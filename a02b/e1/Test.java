...
/**
 * Si consulti la documentazione della interfaccia PatternExtractorFactory, che
 * modella una factory per PatternExtractor, che a sua volta modella un
 * trasformatore da liste a liste, che funziona isolando nell'input pezzi di
 * lista i cui valori hanno certe caratteristiche e producendo conseguentemente
 * una informazione riassuntiva in uscita per ognuno di questi pezzi.
 * 
 ...
 * punteggio: - implementazione dei test opzionali (denominati
 * 'optionalTestXYZ', ossia quelli relativi a
 * PatternExtractorFactory.sumNumericStrings) - concisione del codice e
 * rimozione di tutte le ripetizioni
 *
